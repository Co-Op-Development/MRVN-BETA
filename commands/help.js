...
let cmd = args[0];
if (cmd) {
if (!client.commands.has(cmd)) return message.channel.send('Please provide a command which is shown in the help command!'); if (client.commands.get(cmd).help.inHelp === 'no') return message.channel.send('Pl$
